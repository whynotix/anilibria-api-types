...
from anilibria_api_types.codegen.enums.accounts import AccountsUsersUserCollectionType, AccountsUsersUserFavoriteFilterSorting
from anilibria_api_types.codegen.enums.ads import AdsBannerPlacement
from anilibria_api_types.codegen.enums.anime import AnimeCatalogFilterProductionStatus, AnimeCatalogFilterPublishStatus, AnimeCatalogFilterSorting, AnimeReleasesReleaseAgeRating, AnimeReleasesReleaseMemberRole, AnimeReleasesReleasePublishDay, AnimeReleasesReleaseSeason, AnimeReleasesReleaseType, AnimeTorrentsTorrentCodec, AnimeTorrentsTorrentColor, AnimeTorrentsTorrentMemberRole, AnimeTorrentsTorrentQuality, AnimeTorrentsTorrentType
...
class AccountsUsersMeViewsHistoryItem(AccountsUsersV1UserView):
	release_episode: AccountsUsersMeViewsHistoryItemReleaseEpisode | None = None
...
class AccountsUsersMeViewsHistoryItemReleaseEpisode(AnimeReleasesV1ReleaseEpisode):
...
class AccountsUsersMeCollectionsIdsItem(RootModel):
	root: Union[float, AccountsUsersUserCollectionType]
...
class AccountsUsersMeViewsTimecodesItem(RootModel):
	root: Union[uuid.UUID, float, bool]
