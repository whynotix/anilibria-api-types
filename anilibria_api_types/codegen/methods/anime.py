...
class AnimeMethod(BaseMethod):
    ...
    async def catalog_references_production_statuses(
        ...
        return AnimeCatalogReferencesProductionStatuses.model_validate(
            response
        )
    ...
    async def catalog_releases_get(
        ...
        f_publish_statuses: list[AnimeCatalogFilterPublishStatus]
        | None = None,
        f_production_statuses: list[AnimeCatalogFilterProductionStatus]
        | None = None,
        ...
        params = {
            ...
            for k, v in {
                ...
                "f[genres]": f_genres,
                "f[types]": (
                    [v.value for v in f_types] if f_types is not None else None
                ),
                "f[seasons]": (
                    [v.value for v in f_seasons]
                    if f_seasons is not None
                    else None
                ),
                "f[years][from_year]": f_years_from_year,
                "f[years][to_year]": f_years_to_year,
                "f[search]": f_search,
                "f[sorting]": (
                    f_sorting.value if f_sorting is not None else None
                ),
                "f[age_ratings]": (
                    [v.value for v in f_age_ratings]
                    if f_age_ratings is not None
                    else None
                ),
                "f[publish_statuses]": (
                    [v.value for v in f_publish_statuses]
                    if f_publish_statuses is not None
                    else None
                ),
                "f[production_statuses]": (
                    [v.value for v in f_production_statuses]
                    if f_production_statuses is not None
                    else None
                ),
                "include": include,
                "exclude": exclude,
    ...
    async def catalog_releases_post(
        ...
        response = await self.api.post(
            "/anime/catalog/releases", json_data=data
        )
        return AnimeCatalogReleases.model_validate(response)
    ...
    async def franchises_franchiseid(
        ...
        response = await self.api.get(
            f"/anime/franchises/{franchiseid}", params=params
        )
    ...
    async def franchises_random(
        ...
        response = await self.api.get(
            "/anime/franchises/random", params=params
        )
    ...
    async def franchises_release_releaseid(
        ...
        response = await self.api.get(
            f"/anime/franchises/release/{releaseid}", params=params
        )
    ...
    async def genres_genreid(
        ...
        response = await self.api.get(
            f"/anime/genres/{genreid}", params=params
        )
    ...
    async def genres_genreid_releases(
        ...
        response = await self.api.get(
            f"/anime/genres/{genreid}/releases", params=params
        )
    ...
    async def releases_episodes_releaseepisodeid(
        ...
        response = await self.api.get(
            f"/anime/releases/episodes/{releaseepisodeid}", params=params
        )
    ...
    async def releases_episodes_releaseepisodeid_timecode(
        ...
        response = await self.api.get(
            f"/anime/releases/episodes/{releaseepisodeid}/timecode",
            params=params,
        )
    ...
    async def releases_idoralias(
        ...
        response = await self.api.get(
            f"/anime/releases/{idoralias}", params=params
        )
    ...
    async def releases_idoralias_episodes_timecodes(
        ...
        response = await self.api.get(
            f"/anime/releases/{idoralias}/episodes/timecodes", params=params
        )
    ...
    async def releases_idoralias_members(
        ...
        response = await self.api.get(
            f"/anime/releases/{idoralias}/members", params=params
        )
    ...
    async def torrents_hashorid(
        ...
        response = await self.api.get(
            f"/anime/torrents/{hashorid}", params=params
        )
    ...
    async def torrents_hashorid_file(
        ...
        return await self.api.get(
            f"/anime/torrents/{hashorid}/file", params=params
        )
    ...
    async def torrents_release_releaseid(
        ...
        response = await self.api.get(
            f"/anime/torrents/release/{releaseid}", params=params
        )
    ...
    async def torrents_rss(
        ...
        params = {
            k: v
            for k, v in {"limit": limit, "pk": pk}.items()
            if v is not None
        }
    ...
    async def torrents_rss_release_releaseid(
        ...
        params = {k: v for k, v in {"pk": pk}.items() if v is not None}
        return await self.api.get(
            f"/anime/torrents/rss/release/{releaseid}", params=params
        )
