...
class AccountsMethod(BaseMethod):
    async def otp_accept(self, code: int):
        """
    ...
    async def otp_get(self, device_id: str) -> AccountsOtpGet:
        """
        Запрашивает OTP
        """
    ...
    async def otp_login(self, code: int, device_id: str) -> AccountsOtpLogin:
        """
        Авторизуемся по OTP
        """
    ...
    async def users_auth_password_forget(self, email: str):
        """
    ...
    async def users_auth_social_provider_login(
        ...
        """
        response = await self.api.get(
            f"/accounts/users/auth/social/{provider.value}/login"
        )
    ...
    async def users_me_collections_references_age_ratings(
        ...
        return AccountsUsersMeCollectionsReferencesAgeRatings.model_validate(
            response
        )
    ...
    async def users_me_collections_references_genres(
        ...
        return AccountsUsersMeCollectionsReferencesGenres.model_validate(
            response
        )
    ...
    async def users_me_collections_references_types(
        ...
        return AccountsUsersMeCollectionsReferencesTypes.model_validate(
            response
        )
    ...
    async def users_me_collections_references_years(
        ...
        return AccountsUsersMeCollectionsReferencesYears.model_validate(
            response
        )
    ...
    async def users_me_collections_releases_get(
        ...
        params = {
            ...
            for k, v in {
                "type_of_collection": (
                    type_of_collection.value
                    if type_of_collection is not None
                    else None
                ),
                "page": page,
                "limit": limit,
        ...
        response = await self.api.get(
            "/accounts/users/me/collections/releases", params=params
        )
    ...
    async def users_me_collections_releases_post(
        ...
        response = await self.api.post(
            "/accounts/users/me/collections/releases", json_data=data
        )
        return AccountsUsersCollectionsReleases.model_validate(response)
    ...
    async def users_me_favorites_references_age_ratings(
        ...
        return AccountsUsersMeFavoritesReferencesAgeRatings.model_validate(
            response
        )
    ...
    async def users_me_favorites_references_genres(
        ...
        return AccountsUsersMeFavoritesReferencesGenres.model_validate(
            response
        )
    ...
    async def users_me_favorites_references_sorting(
        ...
        return AccountsUsersMeFavoritesReferencesSorting.model_validate(
            response
        )
    ...
    async def users_me_favorites_releases_get(
        ...
        response = await self.api.get(
            "/accounts/users/me/favorites/releases", params=params
        )
    ...
    async def users_me_favorites_releases_post(
        ...
        response = await self.api.post(
            "/accounts/users/me/favorites/releases", json_data=data
        )
        return AccountsUsersMeFavoritesReleases.model_validate(response)
    ...
    async def users_me_profile(
        ...
        response = await self.api.get(
            "/accounts/users/me/profile", params=params
        )
